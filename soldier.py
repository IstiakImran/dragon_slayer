...
def mouse(button, state, x, y):
    ...
    if button == GLUT_LEFT_BUTTON:
        ...
        start_pos = [-2.0, 1.5 + warrior_y_pos, -3.0]

        rotated_x = start_pos[0] * \
            math.cos(-azimuth_rad) - start_pos[2] * math.sin(-azimuth_rad)
        rotated_z = start_pos[0] * \
            math.sin(-azimuth_rad) + start_pos[2] * math.cos(-azimuth_rad)

        projectiles.append({
            'pos': [rotated_x, start_pos[1], rotated_z],
